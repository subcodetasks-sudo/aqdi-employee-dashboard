        ...
        return (
          <div key={item.label} className="flex items-center gap-3 min-w-0">
            {showValue && valuePosition === "start" && (
              <span className="text-[13px] font-semibold text-[#111827] w-14 shrink-0 text-left tabular-nums">
            ...
            <div className="flex-1 min-w-0 flex items-center gap-2">
              ...
              <span className="text-[13px] text-[#374151] shrink-0 min-w-[80px] text-right truncate">
                {item.label}
              </span>
            </div>
            {showValue && valuePosition === "end" && (
              <span className="text-[13px] font-semibold text-[#111827] w-20 shrink-0 text-left tabular-nums">
                {formatDisplay(item.value, item.suffix)}
              </span>
            )}
          </div>
