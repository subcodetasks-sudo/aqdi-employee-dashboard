...
export default function DisplayMessageForClientDialog({ messageAlert }) {
  ...
  return (
    <Dialog dir="rtl" open={open} onOpenChange={setOpen}>
      ...
      <DialogContent
        closeButton={false}
        className="max-w-md max-h-[90vh] gap-0 overflow-x-hidden overflow-y-auto rounded-2xl border-[#E6EBE9] p-0 shadow-[0_12px_40px_rgba(11,83,69,0.12)] sm:max-w-md sm:rounded-2xl"
      >
        ...
        <div dir="rtl" className="flex flex-col gap-3 px-5 py-4 text-right">
          ...
          <div className="rounded-xl border border-[#E6EBE9] bg-white px-3.5 py-3">
            ...
            <p className="mt-2 whitespace-pre-wrap text-[13px] font-medium leading-relaxed text-[#374151]">
              {message}
            </p>
          </div>
        </div>
