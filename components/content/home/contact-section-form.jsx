                  ...
                  <div className="rounded-3xl border border-dashed border-[#D9D9D9] bg-white p-4">
                    {preview ? (
                      <div className="space-y-4">
                        <div className="relative h-[260px] w-full overflow-hidden rounded-20 border border-surface-border bg-neutral-50">
                          <Image
                            src={preview}
                      ...
                      <label className="flex min-h-[150px] cursor-pointer flex-col items-center justify-center gap-3 rounded-20 bg-white px-6 py-8 text-center transition-all hover:bg-neutral-50">
