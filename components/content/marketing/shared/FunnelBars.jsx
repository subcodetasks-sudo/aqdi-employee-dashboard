      ...
      {steps.map((step, index) => {
        ...
        return (
          <div key={step.label} className="flex items-center gap-3">
            {index > 0 ? (
              <span className="text-[11px] font-bold text-[#DC2626] w-12 shrink-0 text-left tabular-nums">
                {step.dropPct}
              </span>
            ) : (
            ...
            <div className="flex-1 min-w-0 flex items-center gap-3">
              <div className="flex-1 h-8 bg-[#F3F4F6] rounded-md overflow-hidden">
                <div
                  className="h-full rounded-md bg-[#0B5345] transition-all duration-500 flex items-center px-3"
                  style={{ width: `${width}%` }}
                >
              ...
              <span className="text-[13px] text-[#374151] shrink-0 min-w-[70px] text-right">
                {step.label}
              </span>
            </div>
          </div>
