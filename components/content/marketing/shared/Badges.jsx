...
export function SourceBadge({ source, className }) {
  ...
  return (
    <span
      className={cn("inline-flex items-center rounded-md px-2 py-0.5 text-11 font-bold shrink-0", className)}
...
export function StatusDot({ status, className }) {
  ...
  return (
    <span className={cn("inline-flex items-center gap-1.5 text-xs font-bold", className)} style={{ color: style.text }}>
      <span
...
export function StatusPill({ status, className }) {
  ...
  return (
    <span
      className={cn("inline-flex items-center rounded-full px-2.5 py-1 text-11 font-bold shrink-0", className)}
      style={{ backgroundColor: style.bg, color: style.text }}
    >
      {status}
    </span>
...
export function TrendBadge({ trend, className }) {
  ...
  return (
    <span className={cn("inline-flex items-center gap-1 text-xs font-bold", className)} style={{ color: style.text }}>
      {trend}
