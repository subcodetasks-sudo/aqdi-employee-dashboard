...
function ButtonPreview({ label, text, link }) {
  return (
    <div className="rounded-xl border border-[#EEF1F0] bg-[#FAFBFA] p-3.5">
      <p className="mb-1.5 text-[11px] font-bold text-[#9CA3AF]">{label}</p>
      <p className="text-[13px] font-bold text-[#111827]">{text || "—"}</p>
      <a
        href={link || undefined}
...
export default function PaymentMessageCard({ item, type }) {
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden rounded-2xl border border-[#E6EBE9] bg-white shadow-[0_4px_12px_rgba(11,83,69,0.04)]">
      <div className="flex items-start justify-between gap-3 border-b border-[#EEF1F0] px-5 py-4">
        <div className="flex min-w-0 items-start gap-3 text-right">
          ...
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              <h3 className="text-[15px] font-black text-[#111827]">{meta.label}</h3>
              <span
      ...
      <div className="flex flex-1 flex-col gap-4 p-5">
        {hasItem ? (
          <>
            <div className="rounded-xl border border-[#EEF1F0] bg-white p-4">
              <p className="mb-2 text-[11px] font-bold text-[#9CA3AF]">نص الرسالة</p>
              <p className="text-[13px] font-bold leading-7 text-[#111827]">
                {item.message || "—"}
              </p>
            </div>
          ...
          <div className="flex flex-1 flex-col items-center justify-center rounded-xl border border-dashed border-[#E6EBE9] bg-[#FAFBFA] px-5 py-10 text-center">
            <span
            ...
            <p className="mb-1 text-[14px] font-black text-[#111827]">
              لا توجد رسالة مضافة بعد
            </p>
            <p className="mb-5 max-w-xs text-[12px] leading-6 text-[#6B7280]">
